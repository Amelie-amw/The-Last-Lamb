...
cg_texts = [
    ["You recently arrived at a desolate town."],
    ["All the villagers were enthusiastic."],
...
def storyLine():
    ...
    while running and dialogue_index < len(cg_texts):
        ...
        # Render each line in the current dialogue
        for i, line in enumerate(cg_texts[dialogue_index]):
            dialogue(line, 50, HEIGHT - 110 + i * 25)  # 25 pixels between lines
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                dialogue_index += 1  # Go to next dialogue
...
def nightCome():
    ...
    pygame.time.delay(600)  # Slight pause before teleporting
    timeGame()  # Call your game start function here
...
def timeGame():  
    ...
    while running:
        ...
        # Game end conditions
        if won:
            win_text = font.render("YOU WON! Press ESC to exit", True, (0, 255, 0))
